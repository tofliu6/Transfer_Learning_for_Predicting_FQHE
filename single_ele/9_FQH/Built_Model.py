...
def feed_forward(dim_input: int = 12, dim_feedforward: int = 2048) -> nn.Module:
...
def linear_encoded(input: Tensor) -> Tensor:
    ...
    init_layer = nn.Linear(seq_width, 12)
    tensor = init_layer(input)
    tensor = tensor.reshape(1, -1, 12)
